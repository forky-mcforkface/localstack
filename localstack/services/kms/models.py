...
def _serialize_ciphertext_blob(ciphertext: str) -> str:
    header = struct.pack(
...
def deserialize_ciphertext_blob(ciphertext_blob: str) -> str:
...
def _decrypt(
    key_material: str, ciphertext: Ciphertext, encryption_context: EncryptionContextType
) -> str:
    aad = _serialize_encryption_context(encryption_context=encryption_context)
...
class KmsKey:
    ...
    def encrypt(self, plaintext: str, encryption_context: Dict = {}) -> str:
        return _encrypt(
    ...
    def decrypt(self, ciphertext: str, encryption_context: Dict = {}) -> str:
...
def get_key_id_from_any_id(some_id: str, store: KmsStore) -> str:
    alias_name = None
    key_id = None
